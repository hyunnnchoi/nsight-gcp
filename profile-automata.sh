...
summary_data = [["Sheet Name", "COMPUTE/10", "NETWORK/10"]]
...
echo "All processing is complete! The final combined Excel file with a Summary sheet is saved at $FINAL_EXCEL_FILE."
