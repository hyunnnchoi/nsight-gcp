...
train_trace = [('alexnet', 1, 10), ('alexnet', 2, 10), ('alexnet', 4, 10), ('alexnet', 8, 10), ('resnet110', 1, 10), ('resnet110', 2, 10), ('resnet110', 4, 10), ('resnet110', 8, 10), ('resnet44', 1, 10), ('resnet44', 2, 10), ('resnet44', 4, 10), ('resnet44', 8, 10), ('resnet56', 1, 10), ('resnet56', 2, 10), ('resnet56', 4, 10), ('resnet56', 8, 10), ('densenet40_k12', 1, 10), ('densenet40_k12', 2, 10), ('densenet40_k12', 4, 10), ('densenet40_k12', 8, 10), ('googlenet', 1, 10), ('googlenet', 2, 10), ('googlenet', 4, 10), ('googlenet', 8, 10), ('densenet100_k12', 1, 10), ('densenet100_k12', 2, 10), ('densenet100_k12', 4, 10), ('densenet100_k12', 8, 10), ('vgg16', 1, 10), ('vgg16', 2, 10), ('vgg16', 4, 10), ('vgg16', 8, 10), ('resnet50', 1, 10), ('resnet50', 2, 10), ('resnet50', 4, 10), ('resnet50', 8, 10), ('inception3', 1, 10), ('inception3', 2, 10), ('inception3', 4, 10), ('inception3', 8, 10)]
...
def generate_cnn_tfjob_yaml(job_name, job_config):
    ...
    if worker_num > 1:
        command = f'python /tf_cnn_benchmarks/tf_cnn_benchmarks.py --variable_update=parameter_server --model={model_name} --data_name={dataset_name} --display_every=1 --batch_size={batch_size} --cross_replica_sync=true --num_batches={num_batches} --num_warmup_batches=0 > /result/{job_name_ub}/{job_name_ub}_${{JOB}}_log.txt;'
    else:
